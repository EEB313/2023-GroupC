...
simulated data. We are also interested in optimizing the performance of our code, so that the fitting calculations can be more quickly derived. Findings from our research would clarify the importance of each parameter in the Ross-Macdonald model. Furthermore, our findings may enhance the computational efficiency for subsequent and similar research. 
